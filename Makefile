...
apiserve:
	BINDER_DB_DRIVER=postgres BINDER_DB_SOURCE="postgres://postgres:${DKR_POSTGRES_PWD}@localhost:${DKR_POSTGRES_PORT}/binder?sslmode=disable" go run main_api.go

uiserve:
	REDIS_URI=localhost:6379 go run ui/main_ui.go
